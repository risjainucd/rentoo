...
// Ascending by pixel width. 'thumb' is generated by scripts/watermark-upload.mjs but does not
// exist in R2 for the already-uploaded photos — nothing may request it until that pipeline
// (and its video/admin twins) has been re-run over the whole inventory.
export type MediaSize = 'thumb' | 'card' | 'gallery' | 'full';
