...
export function MobileNav({ links }: Props) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
        ...
        >
          <line
            ...
            style={{
              ...
              transition: "transform 150ms cubic-bezier(0.22,0.61,0.36,1), opacity 150ms cubic-bezier(0.22,0.61,0.36,1)",
      ...
      <SheetContent side="left" showCloseButton={false} className="mobile-sheet-content">
